            ...
            get
            {
                if (firstTimeCoordinator)
                {
                    ...
                    new InstanceContext(this),
                        binding,
                        new EndpointAddress("net.tcp://finalamicluster.westus.cloudapp.azure.com:10301/TransactionCoordinatorProxy/Scada/")
            ...
            get
            {
                if (firstTimeCE)
                {
                    ...
                    DuplexChannelFactory<ICalculationEngineForScada> factory = new DuplexChannelFactory<ICalculationEngineForScada>(new InstanceContext(this), binding,
                                                                                        new EndpointAddress("net.tcp://finalamicluster.westus.cloudapp.azure.com:10101/CEProxy/Scada/")
