...
namespace TelventDMS.Services.NetworkModelService.TestClient.Tests
{
	...
	{			
		...
		public List<long> GetRelatedValues(long sourceGlobalId, Association association)
		{
			...
			{
                //////////////
                //List<ModelCode> properties = modelResourcesDesc.GetAllPropertyIds(dma);
                //List<ModelCode> properties = modelResourcesDesc.GetAllPropertyIds(association.PropertyId);
                //long nesto = (long)association.PropertyId;
                //List<ModelCode> properties = modelResourcesDesc.GetAllPropertyIdsForEntityId((long)association.PropertyId);
                //modelResourcesDesc.GetAllPropertyIdsForEntityId(nesto);
